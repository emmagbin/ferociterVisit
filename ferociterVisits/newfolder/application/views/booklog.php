                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                            ...
                                            <div class="dropdown-menu notification-dropdown-menu shadow-lg border-0 p-3 m-0 dropdown-menu-right">
                                                <a class="dropdown-item p-2" href="dashboard">
                        ...
                        <div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card grow">
                            <div class="card-body">
                                <div class="flex-row list-group list-group-horizontal-lg" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a style="min-width: 50%;" class="list-group-item" id="v-pills-home-tab" data-toggle="pill" href="#parent1" role="tab" aria-controls="v-pills-home" aria-selected="true">Visitors Sign In</a>
                                                ...
                                                <div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card grow">
                                                    <div class="card-body">
                                                        <div class="flex-row list-group list-group-horizontal-lg" id="myTab" role="tablist" aria-orientation="vertical">
                                                            ...
                                                            <a style="min-width: 50%;" class=" active list-group-item" id="v-pills-home-tab" data-toggle="pill" href="#child1" role="tab" aria-controls="v-pills-home" aria-selected="true">New Visitor</a>
                                                            <a style="min-width: 50%;" class="list-group-item" id="v-pills-profile-tab" data-toggle="pill" href="#child2" role="tab" aria-controls="v-pills-profile" aria-selected="false"> Regular Visitor</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <section class="signature-component">
                                                                                ...
                                                                                <canvas name="signature" id="signature-pad" width="410px;" height="300px;"></canvas>
                                                                                <div>
                                                                ...
                                                                <div class="col-md-12 form-group">
                                                                    ...
                                                                    <datalist id="text_editorsRegular">
                                                                        <select>
                                                                            ...
                                                                            <option value="Atom">magbin
                                                                            <option value="Brackets">ima
                                                                            <option value="Notepad ++">kofi Magbin
                                                                            <option value="Notepad">Yaw iiim
                                                                            <option value="Sublime Text">Bell Text
                                                                            <option value="Bell Text">Gifty
                                                                            <option value="TextMate">TextMate
                                                                            <option value="Wordpad">Wordpad
                                                                        </select>
                                                                    </datalist>
