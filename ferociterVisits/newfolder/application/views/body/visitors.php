                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($visitors as $record) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url("visitor/" . $record->contact); ?>" class="avatar"><img alt="avatar image" src="assets/img/profiles/img-5.jpg" class="img-fluid" value="<?php echo $record->contact; ?>"></a>
                                            </td>
                                            <td>
