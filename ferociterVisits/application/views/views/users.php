...
<body>
    ...
    <!-- ///////////////////////////////////////////////////////////////////////////////////// -->
    <div class="modal fade" id="allowaccess">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="admin_controller/user_reset_lock_unlock">
                    <!-- Modal body -->
                    <div class="modal-body">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <center>
                            <h4 class="modal-title mb-4">ALLOW ACCESS TO SYSTEM</h4>
                            ...
                            <Span>ARE U SURE YOU WANT TO ALLOW <span class="txtfullname" style="color: red;"></span> ACCESS TO THE SYSTEM?</Span><br><br>

                            <button type="button" class="btn btn-danger text-white text-center ctm-border-radius mb-2 mr-3" data-dismiss="modal">Cancel</button>
                            <button type="submit" class="btn btn-theme text-white ctm-border-radius button-1">Allow</button>
    ...
    <div class="modal fade" id="declineaccess">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="admin_controller/user_reset_lock_unlock">
                    <!-- Modal body -->
                    <div class="modal-body">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <center>
                            <h4 class="modal-title mb-4">DECLINE ACCESS TO SYSTEM</h4>
                            ...
                            <Span>ARE U SURE YOU WANT DECLINE <span class="txtfullname" style="color: red;"></span> ACCESS TO THE SYSTEM?</Span><br><br>

                            <button type="button" class="btn btn-danger text-white text-center ctm-border-radius mb-2 mr-3" data-dismiss="modal">Cancel</button>
                            <button type="submit" class="btn btn-theme text-white ctm-border-radius button-1">Yes</button>
    ...
    <div class="modal fade" id="disablestuff">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="admin_controller/user_reset_lock_unlock">
                    <!-- Modal body -->
                    <div class="modal-body">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <center>
                            <h4 class="modal-title mb-4">DISABLE STUFF</h4>

                            <input type="hidden" name="id" class="txtid">

                            <input type="hidden" name="action" value="lockstuff">

                            <input type="hidden" class="txtcontact" name="contact">
                            <input type="hidden" class="txtemail" name="email">

                            <Span>ARE U SURE YOU WANT TO DISABLE <span class="txtfullname" style="color: red;"></span> IN THE SYSTEM?</Span><br><br>
    ...
    <div class="modal fade" id="enablestuff">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="admin_controller/user_reset_lock_unlock">
                    <!-- Modal body -->
                    <div class="modal-body">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <center>
                            <h4 class="modal-title mb-4">ENABLE STUF</h4>

                            <input type="hidden" name="id" class="txtid">

                            <input type="hidden" name="action" value="unlockstuff">

                            <input type="hidden" class="txtcontact" name="contact">
                            <input type="hidden" class="txtemail" name="email">

                            <Span>ARE U SURE YOU WANT TO ANABLE <span class="txtfullname" style="color: red;"></span>IN THE SYSTEM?</Span><br><br>
